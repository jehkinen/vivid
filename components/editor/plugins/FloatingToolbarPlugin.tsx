...
import { FloatingLinkEditor } from '../floating/FloatingLinkEditor'
import { FloatingLinkPreview } from '../floating/FloatingLinkPreview'
import { editorFloatingShellClassName } from '../floating/editor-floating-shell'

interface FloatingToolbarPluginProps {
  onOpenChange?: (open: boolean) => void
}

export function FloatingToolbarPlugin({ onOpenChange }: FloatingToolbarPluginProps) {
